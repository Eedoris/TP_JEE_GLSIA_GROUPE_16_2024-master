...
import { SidebarComponent } from './sharepages/sidebar/sidebar/sidebar.component';
...
const routes: Routes = [
  ...
  {path:'admilistecpte',component:AdmilistecpteComponent},
  {path:'admintransacComponent',component:AdmitransacComponent},
  {path:'admihome',component:AdmihomeComponent}
